...
public class OperationConfigs {
  ...
  public OperationConfigs(Integer maxCommitDelayMillis) {
    this.maxCommitDelayMillis = maxCommitDelayMillis;
  }

  public static OperationConfigs fromMap(Map<String, Object> yamlMap) {
    Integer maxCommitDelayMillis = (Integer) yamlMap.get("maxCommitDelayMillis");
    return new OperationConfigs(maxCommitDelayMillis);
  }
